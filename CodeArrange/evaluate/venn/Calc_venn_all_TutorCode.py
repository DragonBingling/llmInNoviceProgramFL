...
def analyze_TutorCode(prompt,experiment_index,experiment_model,rangeIndex,root_path):
    ...
    for versionInt in range(0, 1544):
        ...
        if topN_Index <= 1:
            top1 += 1
            # istop1=1
            top1_list.add(str(versionInt))
        if topN_Index <= 3:
            top3 += 1
        if topN_Index <= 5:
            top5 += 1
            # istop5=1
            top5_list.add(str(versionInt))
        if topN_Index <= 10:
            top10 += 1
            # istop10=1
            top10_list.add(str(versionInt))
        else:
            topNull += 1
...
def analyze_sbfl_mbfll(formula, method, root_path,dataset):
    ...
    for version in range(0, 114):
        ...
        if topN_Index <= 1:
            top1 += 1
            # istop1=1
            top1_list.add(version)
        if topN_Index <= 3:
            top3 += 1
        if topN_Index <= 5:
            top5 += 1
            # istop5=1
            top5_list.add(version)
        if topN_Index <= 10:
            top10 += 1
            # istop10=1
            top10_list.add(version)
        else:
            topNull += 1
...
if __name__ == "__main__":
    ...
    ans_deepseek = analyze_TutorCode("prompt", 'normal_1', "deepseek-r1", 114, root_path)
    ans_gpt4 = analyze_TutorCode("prompt", 'normal_1', "gpt-4", 114, root_path)
    ans_gpt4o = analyze_TutorCode("prompt", 'normal_1', "gpt-4o", 114, root_path)
    ans_GLM4 = analyze_TutorCode("prompt", 'normal_1', "glm-4", 114, root_path)
    ans_llama = analyze_TutorCode("prompt", 'normal_1', "llama-3.1-405b-instruct", 114, root_path)

    root_path = "D:/私人资料2024/论文/大模型相关/多代理新手程序错误定位实验/data/tutorcode/results"
    ans_dstarMBFL = analyze_sbfl_mbfll("dstar", "MBFL", root_path, "Codeflaws")
    ans_ochiMBFL = analyze_sbfl_mbfll("ochi", "MBFL", root_path, "Codeflaws")
    ans_op2MBFL = analyze_sbfl_mbfll("op", "MBFL", root_path, "Codeflaws")
    ans_dstarSBFL = analyze_sbfl_mbfll("dstar", "VSBFL", root_path, "Codeflaws")
    ans_ochiSBFL = analyze_sbfl_mbfll("ochi", "VSBFL", root_path, "Codeflaws")
    ans_op2SBFL = analyze_sbfl_mbfll("op", "VSBFL", root_path, "Codeflaws")
    ...
    # 第一行
    venn1=venn3([ans_deepseek[index], ans_gpt4o[index], ans_gpt4[index]], ('', '', ''), ax=axs[0, 0])
    circles = venn3_circles([ans_deepseek[index], ans_gpt4o[index], ans_gpt4[index]],
    ...
    axs[0, 0].set_title("GPT-4")
    venn2=venn3([ans_deepseek[index], ans_gpt4o[index], ans_GLM4[index]], ('', '', ''), ax=axs[0, 1])
    circles = venn3_circles([ans_deepseek[index], ans_gpt4o[index], ans_GLM4[index]],
                            linestyle='solid', linewidth=line_width, color=border_color
                            , ax=axs[0, 1])
    axs[0, 1].set_title("GLM4")
    venn4=venn3([ans_deepseek[index], ans_gpt4o[index], ans_llama[index]], ('', '', ''), ax=axs[0, 2])
    circles = venn3_circles([ans_deepseek[index], ans_gpt4o[index], ans_llama[index]],
                            linestyle='solid', linewidth=line_width, color=border_color
                            , ax=axs[0, 2])
    axs[0, 2].set_title("LLama3")

    # 第二行
    venn5=venn3([ans_deepseek[index], ans_gpt4o[index], ans_ochiMBFL[index]], ('', '', ''), ax=axs[1, 0])
    circles = venn3_circles([ans_deepseek[index], ans_gpt4o[index], ans_ochiMBFL[index]],
                            linestyle='solid', linewidth=line_width, color=border_color
                            , ax=axs[1, 0])
    axs[1, 0].set_title("MBFL$_{Ochiai}$")
    venn6=venn3([ans_deepseek[index], ans_gpt4o[index], ans_dstarMBFL[index]], ('', '', ''), ax=axs[1, 1])
    circles = venn3_circles([ans_deepseek[index], ans_gpt4o[index], ans_dstarMBFL[index]],
                            linestyle='solid', linewidth=line_width, color=border_color
                            , ax=axs[1, 1])
    axs[1, 1].set_title("MBFL$_{Dstar}$")
    venn7=venn3([ans_deepseek[index], ans_gpt4o[index], ans_op2MBFL[index]], ('', '', ''), ax=axs[1, 2])
    circles = venn3_circles([ans_deepseek[index], ans_gpt4o[index], ans_op2MBFL[index]],
                            linestyle='solid', linewidth=line_width, color=border_color
                            , ax=axs[1, 2])
    ...
    # 第三行
    venn8=venn3([ans_deepseek[index], ans_gpt4o[index], ans_ochiSBFL[index]], ('', '', ''), ax=axs[2, 0])
    circles = venn3_circles([ans_deepseek[index], ans_gpt4o[index], ans_ochiSBFL[index]],
                            linestyle='solid', linewidth=line_width, color=border_color
                            , ax=axs[2, 0])
    axs[2, 0].set_title("VSBFL$_{Ochiai}$")
    venn9=venn3([ans_deepseek[index], ans_gpt4o[index], ans_dstarSBFL[index]], ('', '', ''), ax=axs[2, 1])
    circles = venn3_circles([ans_deepseek[index], ans_gpt4o[index], ans_ochiSBFL[index]],
                            linestyle='solid', linewidth=line_width, color=border_color
                            , ax=axs[2, 1])
    axs[2, 1].set_title("VSBFL$_{Dstar}$")
    venn10=venn3([ans_deepseek[index], ans_gpt4o[index], ans_op2SBFL[index]], ('', '', ''), ax=axs[2, 2])
    circles = venn3_circles([ans_deepseek[index], ans_gpt4o[index], ans_ochiSBFL[index]],
                            linestyle='solid', linewidth=line_width, color=border_color
                            , ax=axs[2, 2])
    axs[2, 2].set_title("VSBFL$_{Op2}$")
    ...
    labels = ['DeepSeek', 'ChatGPT-4o', 'Method of Each Title']
    ...
    # 显示图形
    plt.savefig('Tutorcode_overlap.png')
