...
def test_Codeflaws(prompt,experiment_index,experiment_model,rangeIndex):
    ...
    for versionInt in range(1, rangeIndex):
        ...
        send_single_code_faultlocalization(prompt, ans_path, code_location, 6,experiment_model)
...
if __name__ == "__main__":
    prompt_location = "D:/私人资料/论文/大模型相关/大模型错误定位实证研究/错误定位prompt/prompt-要求输出为json格式精简回答.txt"
    code_location_v1 = "D:/私人资料/论文/大模型相关/大模型错误定位实证研究/Codeflaws/version/v1/test_data/defect_root/source/tcas.c"
    ans_path_v1 = "D:/私人资料/论文/大模型相关/大模型错误定位实证研究/Codeflaws/version/v1/test_data/modelAns"
    root_path = "D:/私人资料/论文/大模型相关/大模型错误定位实证研究"
    experiment_index = 1
